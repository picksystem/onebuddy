...
const Categories = () => {
  ...
  const statCards = [
    { label: 'Total', value: tabLists[0]?.length ?? 0, Icon: CategoryIcon, cls: classes.statCard0, sub: 'All content categories', color: '#4f46e5' },
    { label: 'Active', value: tabLists[1]?.length ?? 0, Icon: CheckCircleIcon, cls: classes.statCard2, sub: 'Visible to users', color: '#10b981' },
    { label: 'Inactive', value: tabLists[2]?.length ?? 0, Icon: VisibilityOffIcon, cls: classes.statCard1, sub: 'Hidden from users', color: '#f59e0b' },
    { label: 'Featured', value: tabLists[3]?.length ?? 0, Icon: StarIcon, cls: classes.statCard3, sub: 'Highlighted categories', color: '#0ea5e9' },
  ];
