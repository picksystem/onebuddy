...
const Subscriptions = () => {
  ...
  const statCards = [
    { label: 'Total Plans', value: tabLists[0]?.length ?? 0, Icon: SubscriptionsIcon, cls: classes.statCard0, sub: 'Available plan types', color: '#4f46e5' },
    { label: 'Active', value: tabLists[1]?.length ?? 0, Icon: CheckCircleIcon, cls: classes.statCard2, sub: 'Currently live plans', color: '#10b981' },
    { label: 'Expired', value: tabLists[2]?.length ?? 0, Icon: TimerOffIcon, cls: classes.statCard1, sub: 'Plans that have lapsed', color: '#f59e0b' },
    { label: 'Archived', value: tabLists[3]?.length ?? 0, Icon: ArchiveIcon, cls: classes.statCard3, sub: 'Retired plan versions', color: '#0ea5e9' },
  ];
