...
interface DetailDialogProps {
  ...
  onClose: () => void;
  onOpenAction: (user: AdminRow, type: ActionType) => void;
}
        ...
        <>
          ...
          <Box className={classes.dialogHeader}>
            <Box className={classes.dialogHeaderBadge}>
              <AdminPanelSettingsIcon className={classes.dialogHeaderBadgeIcon} />
              <Typography
                variant='caption'
                fontWeight={700}
            ...
            {detailUser.status === 'pending_approval' && (
              <>
                <Button
                  ...
                  onClick={() => {
                    onOpenAction(detailUser as AdminRow, 'reject');
                    onClose();
                  }}
                >
                  Reject
                ...
                <Button
                  ...
                  onClick={() => {
                    onOpenAction(detailUser as AdminRow, 'approve');
                    onClose();
                  }}
                >
                  Approve
