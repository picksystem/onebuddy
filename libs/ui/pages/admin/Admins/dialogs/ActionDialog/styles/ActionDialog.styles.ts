...
export const useStyles = makeStyles()(() => ({
  ...
  dialogHeaderAvatar: {
    ...
    fontSize: '1.2rem !important', fontWeight: '700 !important',
    backgroundColor: 'rgba(255,255,255,0.25) !important',
    color: '#fff !important',
    border: '2px solid rgba(255,255,255,0.5) !important',
  },
  dialogHeaderUserInfo: { flex: 1, minWidth: 0 },
  dialogHeaderName: { color: '#fff !important', lineHeight: '1.2 !important', fontWeight: '700 !important' },
  ...
  confirmButton: {
    borderRadius: '8px !important',
    paddingLeft: '24px !important', paddingRight: '24px !important',
    '@media (max-width: 599px)': { width: '100% !important', paddingLeft: '16px !important', paddingRight: '16px !important' },
  },
}));
