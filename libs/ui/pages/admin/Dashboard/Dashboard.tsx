...
const Dashboard = () => {
  ...
  const { user } = useAuth();
  const currentTime = useCurrentDate(1000, 'HH:mm:ss');
  const currentDate = useCurrentDate(1000, 'DD MMM YYYY');
      ...
      <Box className={classes.container}>
        ...
        <Box className={classes.heroHeader}>
          ...
          <Box className={classes.heroContent}>
            {/* Top row: Avatar+Welcome  ←→  Time badge */}
            <Box
              sx={{
                display: 'flex',
                ...
                <Box sx={{ position: 'relative', flexShrink: 0 }}>
                  <Box
                    sx={{
                      ...
                      inset: -3,
                      borderRadius: '50%',
                      background: 'linear-gradient(135deg, #6366f1, #38bdf8, #4ade80)',
                      boxShadow: '0 0 16px rgba(99,102,241,0.7), 0 0 32px rgba(56,189,248,0.3)',
                      zIndex: 0,
                    }}
                  />
                  <Avatar
                    ...
                    sx={{
                      width: { xs: 44, sm: 56, md: 68 },
                      height: { xs: 44, sm: 56, md: 68 },
                      border: { xs: '2px solid #0f172a', md: '3px solid #0f172a' },
                ...
                <Box sx={{ minWidth: 0 }}>
                  <Typography
                    sx={{
                      ...
                      textShadow: '0 0 24px rgba(99,102,241,0.5), 0 2px 8px rgba(0,0,0,0.3)',
                    }}
                  >
                    Welcome,&nbsp;
                    <Box
                  ...
                  <Typography
                    sx={{
                      fontSize: { xs: '0.58rem', sm: '0.63rem', md: '0.68rem' },
                      fontWeight: 700,
            ...
            <Typography className={classes.heroSub}>
              Monitor and manage all platform services in one place, including bike, auto, car
              rides, shuttle transport, and goods logistics.
            </Typography>
