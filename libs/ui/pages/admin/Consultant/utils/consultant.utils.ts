...
import { ConsultantRow } from '../types/consultant.types';

export const getTableData = (list: IAuthUser[]): ConsultantRow[] =>
  list.map((r, i) => ({ ...r, sno: i + 1 }));

export const getFilteredData = (list: IAuthUser[], search: string): ConsultantRow[] => {
