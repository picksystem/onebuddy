...
export const getBaseStyles = (theme: Theme): Record<string, CSSObject> => ({
  ...
  pageHeader: {
    ...
    '&::before': {
      ...
      borderRadius: '50%',
      background: 'radial-gradient(circle at center, rgba(129,140,248,0.38) 0%, rgba(79,70,229,0.12) 50%, transparent 70%)',
  ...
  searchField: {
    ...
    '& .MuiOutlinedInput-root': {
      ...
      background: 'rgba(255,255,255,0.92)',
      borderRadius: 40,
      '& .MuiOutlinedInput-notchedOutline': { border: '1px solid rgba(79,70,229,0.18)', borderRadius: 40 },
    ...
    '& .MuiInputAdornment-root .MuiSvgIcon-root': { fontSize: '1.1rem', color: 'rgba(79,70,229,0.6)' },
