...
import { ConsultantRow as UsersRow, ActionType } from '../../types/consultant.types';
            ...
            {detailUser.status === 'pending_approval' && (
              <>
                <Button
                  ...
                  onClick={() => {
                    onOpenAction(detailUser as UsersRow, 'reject');
                    onClose();
                  }}
                >
                  Reject
                ...
                <Button
                  ...
                  onClick={() => {
                    onOpenAction(detailUser as UsersRow, 'approve');
                    onClose();
                  }}
                >
                  Approve
