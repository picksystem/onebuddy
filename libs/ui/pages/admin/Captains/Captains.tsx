      ...
      <Box className={classes.container}>
        ...
        <Box className={classes.pageHeader}>
          ...
          <Typography variant='body2' className={classes.description}>
            Monitor and manage captain onboarding requests for mobility services.
          </Typography>
        </Box>
            ...
            {getFilteredData(list).length === 0 ? (
              ...
              <Box className={classes.tableContainer}>
                <DataTable
                  ...
                  onRowClick={(row) =>
                    setSelectedRow((prev: CaptainsRow | null) =>
                      prev?.id === (row as CaptainsRow).id ? null : (row as CaptainsRow),
                    )
                  }
                  activeRowKey={sel?.id}
                />
