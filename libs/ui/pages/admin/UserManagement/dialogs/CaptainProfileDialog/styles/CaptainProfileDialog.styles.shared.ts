...
export const getBaseStyles = (theme: Theme): Record<string, CSSObject> => ({
  ...
  header: {
    background: theme.palette.gradient.headerGreen,
  ...
  profileCompleteChip: {
    backgroundColor: theme.palette.success.tealAlpha30,
    color: theme.palette.common.white,
    fontWeight: 600,
    border: `1px solid ${theme.palette.success.tealAlpha60}`,
  },
  profileIncompleteChip: {
    backgroundColor: theme.palette.warning.amberAlpha30,
    color: theme.palette.common.white,
    fontWeight: 600,
    border: `1px solid ${theme.palette.warning.amberAlpha60}`,
  },
  closeBtn: {
